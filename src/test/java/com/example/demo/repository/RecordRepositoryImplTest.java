...
class RecordRepositoryImplTest {
    ...
    void findByRecId1() {
        var rec1 = recordRepository.findByRecId(1);
    ...
    void findByPetId1() {
        var list = recordRepository.findByPetId(2);
        // 件数のチェック
    ...
    void update1() {
        ...
        var rec1 = recordRepository.findByRecId(5);
        ...
        var updateCount = recordRepository.update(rec);

        assertEquals(1, updateCount);

        var rec2 = recordRepository.findByRecId(5);
    ...
    void deleteByRecId2() {
        var deleteCount = recordRepository.deleteByRecId(10);
    ...
    void deleteByPetId2() {
        var deleteCount = recordRepository.deleteByPetId(10);
        assertEquals(0, deleteCount);
