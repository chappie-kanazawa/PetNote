...
//    void findByUserId1() {
//        Account account1 = accountDao.findByUserId(0);
//
//        // レコードの存在チェック
...
//    	Optional<Account> accountOpt1 = accountDao.findByUserName("tarotest");
//
//        // レコードの存在チェック
...
//    void findByLogin1() {
//    	Login login1 = new Login("tarotest", "1111test");
...
//
//        Account account2 = accountDao.findByUserId(1);
//
//        // レコードの存在チェック
//        assertNotNull(account2);
//
...
//        int deleteCount = accountDao.deleteByUserId(10);
